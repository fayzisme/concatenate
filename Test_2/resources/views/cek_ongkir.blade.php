                    ...
                    <form id="formTampilkan">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="province_origin" id="province_origin" required>
                                <option value="{{ $provinsiAsal->province_id }}" selected>{{ $provinsiAsal->province }}</option>                                
                            </select>
                        </div>
                        <div class="form-group">
        ...
        .then((res) => {                            
            ...
            if(res.data.length > 0){
                res.data.forEach((data, index) => {
                    ...
                    opt += `
                        <option value="${data.city_id}">${data.city_name} (Kode Pos : ${data.postal_code})</option>                    
                    `;
                })
    ...
    document.addEventListener('DOMContentLoaded', function() {            
        ...
        formTampilkan.onsubmit = (e) => {
            ...
            .then(function (res) {
                ...
                errorContainer.style.display = 'none'; // Menyembunyikan elemen
            ...
            .catch(function (error) {
                $('.loader').hide();
                let errorContainer = document.getElementById('error-container');
                errorContainer.innerHTML = '<div class="alert alert-danger">' + 'Semua field wajid diisi' + '</div>';

                // Munculkan kembali elemen
